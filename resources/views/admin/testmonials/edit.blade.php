...
@section('content')
    <div class="container-fluid">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-3">
            <h2 class="h5 page-title">{{ __('admin.edit_testmonial') }}</h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ $testmonial->name }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="position" value="{{ $testmonial->position }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" rows="4" name="description">{{ $testmonial->description }}</textarea>
